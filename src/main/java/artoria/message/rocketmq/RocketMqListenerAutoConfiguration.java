...
public class RocketMqListenerAutoConfiguration {
    private Map<RocketMqListener, DefaultMQPushConsumer> map = new ConcurrentHashMap<RocketMqListener, DefaultMQPushConsumer>();
    private static Logger log = LoggerFactory.getLogger(RocketMqListenerAutoConfiguration.class);
